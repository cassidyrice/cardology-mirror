...
import { hofCopy, sourceProse } from "./copy";
...
export function renderHofPage(
  ...
  const recordSection = copy.source_record.length
    ? `<section data-slot="source-record">
  ...
  const body = `
    ...
    <section data-slot="cta">
      ...
      <p>The Blueprint Breakdown is a 5-minute video about your own birth card, with the written Deep Dive as a bonus — not a Hall of Fame reading.</p>
      <p>
        <a class="cta"
