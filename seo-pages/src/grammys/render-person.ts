...
import { grammyCopy, sourceProse } from "./copy";
...
export function renderGrammyPage(
  ...
  const body = `
    ...
    <section data-slot="cta">
      ...
      <p>The Blueprint Breakdown is a 5-minute video about your own birth card, with the written Deep Dive as a bonus — not a Grammy reading.</p>
      <p>
        <a class="cta"
