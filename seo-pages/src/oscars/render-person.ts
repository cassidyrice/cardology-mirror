...
import { oscarCopy, sourceProse } from "./copy";
...
export function renderOscarPage(
  ...
  const body = `
    ...
    <section data-slot="cta">
      ...
      <p>The Blueprint Breakdown is a 5-minute video about your own birth card, with the written Deep Dive as a bonus — not an Oscar reading.</p>
      <p>
        <a class="cta"
