...
const TITLE = "Destiny Cards: Free Birth Card Calculator (Not Tarot)";
const DESCRIPTION =
  "Destiny Cards / Cards of Destiny: birthday → one playing card. Free calculator and chart. Not tarot, not fate. Optional $19 52xSeven Blueprint.";
