  ...
  return (
    ...
    >
      ...
      <section className="mt-10">
        <h2 className="type-eyebrow mb-2 !text-brand-bronze">No model writes this document</h2>
      ...
      <section className="mt-10">
        <h2 className="type-eyebrow mb-2 !text-brand-bronze">Inside the report</h2>
      ...
      <section className="mt-10">
        <h2 className="type-eyebrow mb-2 !text-brand-bronze">Six of the pages</h2>
      ...
      <section className="mt-10">
        <h2 className="type-eyebrow mb-2 !text-brand-bronze">How it reads</h2>
        <p className="prose-reading text-brand-ink-soft">
