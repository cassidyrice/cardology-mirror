...
export const metadata: Metadata = {
  ...
  description:
    "Your birth-card pattern, ruling layer, and current chapter — a personalized Cardology report delivered instantly after checkout.",
  alternates: { canonical: "/products/personal-card-blueprint" },
  openGraph: {
    siteName: SITE_NAME,
    title: "Personal Card Blueprint | Card Blueprints",
    description:
      "A personalized Cardology report from your birthday — birth card, ruling card, and the chapter you're in now. Instant, no phone call.",
