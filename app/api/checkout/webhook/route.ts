        ...
        try {
          ...
          await sendIntakeEmail({
            ...
            text: [
              ...
              "",
              `Want the same system read aloud? The AI Cardology voice`,
              `reader delivers birth cards, yearly spreads, and relationship`,
              `dynamics live on the phone: ${READER_PHONE_DISPLAY}`,
              "",
              `Compare voice readings: ${SITE_URL}/readings`,
              "",
