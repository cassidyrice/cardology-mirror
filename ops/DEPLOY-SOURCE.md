...
**Last verified: 2026-09-15** (deployed `main` @ `6f81906` — Reading API: accept the birthday in a POST body; previous record `e2e0b0e`)
...
| **Branch** | `main` |
| **Deployed commit** | `6f81906aac901cb9825474942bf93ebf445d163f` |
