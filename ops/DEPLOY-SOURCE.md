...
**Last verified: 2026-09-08** (deployed `main` @ `b383281` — Homepage: the live 52xSeven preview under the calculator, replacing the still; previous record `4fcdfb7`)
...
| **Branch** | `main` |
| **Deployed commit** | `b383281a671a92e37d76f2f0294213882397983b` |
