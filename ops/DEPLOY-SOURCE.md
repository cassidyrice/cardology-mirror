...
**Last verified: 2026-09-01** (deployed `main` @ `4fc33e9` — spreads hub rebuilt as the real boards, spokes 301d; previous record `51fcb02`)
...
| **Branch** | `main` |
| **Deployed commit** | `4fc33e9b85ec95dac9b5e2dfb398e2222948b561` |
