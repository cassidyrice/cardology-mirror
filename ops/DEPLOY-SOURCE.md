...
**Last verified: 2026-09-04** (deployed `main` @ `adc670e` — Footer: the one disclaimer, in Cass's words; previous record `24317b2`)
...
| **Branch** | `main` |
| **Deployed commit** | `adc670e4cc1160e1fc5cf708324aea580478dbab` |
