...
**Last verified: 2026-09-01** (deployed `main` @ `bac8cac` — $9/$13 bundle split, congruence pass; supersedes unrecorded `16ebfc8`; previous record `1174771`)
...
| **Branch** | `main` |
| **Deployed commit** | `bac8cacba5a46f1d650c9398d31926768f7cfd84` |
