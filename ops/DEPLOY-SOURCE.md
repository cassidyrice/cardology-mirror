...
**Last verified: 2026-09-01** (deployed `main` @ `20c127f` — deck OG images with actual card faces; previous record was `main` @ `ba899e1`)
...
| **Branch** | `main` |
| **Deployed commit** | `20c127f97c05a130b41e17623b19b474ed971992` |
