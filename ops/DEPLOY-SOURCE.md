...
**Last verified: 2026-09-01** (deployed `main` @ `6bd074a` — real card faces on card-meaning heroes; previous record `bac8cac`)
...
| **Branch** | `main` |
| **Deployed commit** | `6bd074a0f4996372cae9c2a282bbd3043264f100` |
