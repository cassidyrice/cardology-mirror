"""Wave slice prefers largest holes and skips already-enriched / empty / DROP qids."""
...
from enrich.make_wave_slice import PRIOR_DROP_QIDS, select_slice, write_wave_slice
...
def test_select_slice_skips_prior_drop_qids(tmp_path: Path) -> None:
    ...
    _write_jsonl(
        ...
        [
            ...
            _person("Q348011", "Joe Montana drop"),
    ...
    assert "Q348011" not in {row["qid"] for row in people}
