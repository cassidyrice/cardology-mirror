...
def auth_blocker_message(config: VertexConfig) -> str:
    ...
    lines += [
        ...
        "",
        "Then rerun:",
        "  python3 -m enrich.submit_batch --input enrich/artifacts/vertex_retry_batch.jsonl",
        "  python3 -m enrich.submit_batch --poll",
        "  python3 -m enrich.parse_results --append --retry-scope enrich/artifacts/retry.jsonl",
    ]
    return "\n".join(lines)
