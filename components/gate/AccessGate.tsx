...
export function AccessGate({
  ...
  const field =
    "w-full rounded-lg border border-brand-line bg-brand-ivory/70 px-3 py-3 text-brand-ink outline-none transition placeholder:text-brand-ink-soft focus:ring-1 focus:ring-gold/40";
