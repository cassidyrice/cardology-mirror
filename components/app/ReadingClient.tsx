      ...
      <Screen>
        <div className="mx-auto max-w-md pt-12">
          <ProfilePrompt
            ...
            body="The reading page now lives on the public website. Create a local profile to generate the personalized report from your fixed card structure."
          />
        </div>
      </Screen>
    );
      ...
      <div className="mx-auto max-w-md">
        ...
        {phase === "error" && (
          <div className="animate-fade-up pt-4 text-center">
            ...
            <button
              onClick={generate}
              className="mt-6 rounded-full border border-brand-line px-6 py-2.5 text-sm transition text-brand-bronze active:scale-[0.97]"
            >
              Try again
            </button>
          </div>
        ...
        {phase === "done" && (
          <div className="animate-fade-up mt-12 flex flex-col items-center gap-3 text-center">
            ...
            <button
              onClick={generate}
              className="mt-2 rounded-full border border-brand-line px-6 py-2.5 text-sm transition text-brand-bronze active:scale-[0.97]"
            >
              Re-read the mirror
            </button>
          </div>
