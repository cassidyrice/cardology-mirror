...
export default function JournalPage() {
  ...
  return (
    <Screen className="starfield bg-cosmic mx-auto max-w-md">
      ...
      {ready && !profile ? (
        <ProfilePrompt
          title="Daily prompts need your cards."
          body="Create a local profile to generate journal prompts from today's card pattern. Past entries stay private on this device."
        />
      ) : (
