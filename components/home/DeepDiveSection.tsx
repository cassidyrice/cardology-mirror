  ...
  return (
    <SectionShell tone="paperDeep">
      <div className="grid gap-10 lg:grid-cols-[minmax(0,14rem)_1fr] lg:items-center lg:gap-14">
        <Image
          src="/og/products/one-question-reading.png"
          alt="The One Question Reading: one question, read from your card and your year"
          width={1200}
          height={630}
        ...
        <div>
          ...
          <p className="mt-6">
            <LinkButton href="/products/one-question-reading" variant="accent">
              Ask one question
            </LinkButton>
          </p>
        </div>
